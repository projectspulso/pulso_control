...
const PROMPT_EXTRACAO = [
  ...
  '',
  'Responda TAMBÉM ao TESTE DA BUSCA, e responda sobre a ÂNCORA que você acabou de escrever:',
  'Se alguém digitasse a sua âncora num buscador, acharia ESTE caso — ou acharia mil coisas?',
  '- nomeado = true → a âncora identifica: "Bluma Zeigarnik 1927", "Pavlopetri", "bismuto',
  '  levitação diamagnética". Um termo técnico específico conta tanto quanto um nome próprio.',
  '- nomeado = false → a âncora só DESCREVE: "cidade lendária 2015", "técnica japonesa de foco",',
  '  "cidade perdida na Amazônia", "testes de percepção visual". São rótulos que servem para',
  '  centenas de casos diferentes — o roteiro abriu a curiosidade e não disse QUAL.',
  'Adjetivo não identifica: "lendária", "misteriosa", "antiga", "perdida" descrevem e não nomeiam.',
  'Na dúvida, responda false: um roteiro a mais na revisão humana custa um minuto; um roteiro que',
  'promete e não entrega custa alcance.',
  '',
