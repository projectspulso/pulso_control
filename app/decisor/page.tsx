 ...
 *
 * As outras 12 áreas do app são a biblioteca de consulta: respondem "quanto foi?". Esta responde
 * a pergunta que se faz ao abrir o app e que nenhuma outra tela respondia: "o que eu faço agora,
 * e por quê?".
 *
